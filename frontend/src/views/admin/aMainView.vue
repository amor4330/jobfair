<template>
  ...
  <div>
    ...
    <div class="empBoxWrap">
      <div class="empBox">
        <div class="empBoxCon">
          <img src="2.jpg" class="companyLogo left">
          <div class="left empBoxText">
            <h3>UIUX 디자이너</h3>
            <p>(주) 카카오</p>
            <p>경력무관   초대졸   경기도 성남시   정규직   3,000~3,400만원</p>
          </div>
...
.companyNum a {display: inline-block;
  width: 200px;
  height:150px;
  ...
  /* border: 2px solid rgb(95, 75, 229); */

}
.companyNum a:first-child { background-color: rgb(95, 75, 229);}
.companyNum a:nth-child(2) {background-color: rgb(229, 75, 75);}
.companyNum a:nth-child(3) {background-color: rgb(62, 162, 72);
}
.companyNum_text {
  position : absolute;
...
.empBox:hover{box-shadow: 2px 2px 8px #d6d6d6;}

.empBoxCon{margin-top:15px;
  margin-left:20px;
  height:70px;
...
.empBoxText{margin-left:20px;}
.empBoxText p{font-size: 13px;margin-top:5px;}
...
.header_size {width:1200px;
  margin:0 auto;
  height:120px;
  line-height: 50px;
}
.header_wrap {padding:30px 20px 20px;}
...
.detailSearch {width:100px;
  height:40px;
  background-color:transparent;
  border:0px;
  color:white;
  background-color: #90aee8;
  border-radius: 10px;
  font-size: 14px;
  cursor: pointer;
  font-weight: bold;
...
.menu li{display:inline-block;margin:0 auto;font-weight: bold;}
.menu li a {display:inline-block;
  width:100px;
  cursor: pointer;}
.menu li a:hover {border-bottom:3px solid white;}
/* 헤더 스타일 끝 */
